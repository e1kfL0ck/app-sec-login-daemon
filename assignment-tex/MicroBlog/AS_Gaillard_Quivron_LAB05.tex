...
\texttt{src/user/validators.py}. Session enforcement is implemented in \texttt{src/session_helpers.py}.

\subsection*{Architecture map}
\begin{center}
\begin{tabular}{|l|l|}
\hline
...
\hline
Session/Auth & \texttt{src/session_helpers.py} \\
\hline
\end{tabular}
\end{center}
