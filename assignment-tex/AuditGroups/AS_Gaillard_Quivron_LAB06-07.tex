...
\section{Openly Accessible Resources}
\textbf{Severity: Low}

\textbf{Description}: \\
The endpoint \texttt{/uploads/memes} is publicly accessible without authentication. This allows any user to view all uploaded memes, which may include sensitive or private content.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/uploads.png}
    \caption{Unauthenticated view of the uploaded memes}
\end{figure}

\textbf{Recommendation}: \\
Restrict access to the \texttt{/uploads/memes} endpoint to authenticated users only.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/SQLi.png}
    \caption{No SQL Injection vulnerabilities found during testing}
\end{figure}
